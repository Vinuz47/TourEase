...
class _MyChartState extends State<MyChart> {
    ...
    return BarChartGroupData(x: x, barRods: [
      BarChartRodData(
          ...
          gradient: LinearGradient(
            ...
            transform: const GradientRotation(pi / 40), //gradient rotation
          ),
          width: 10, //thickness of the bar line
  ...
  List<BarChartGroupData> showingGroups() => List.generate(8, (i) {
        switch (i) {
          ...
          case 4:
            return makeGroupData(4, 3.3);
          case 5:
            return makeGroupData(5, 1.5);
          case 6:
            return makeGroupData(6, 4.3);
          case 7:
            return makeGroupData(7, 3.1);
    ...
    return BarChartData(
      titlesData: FlTitlesData(
        ...
        bottomTitles: AxisTitles(
          ...
          showTitles: true,
          reservedSize: 38, //space between 2 points of the X axis
